...
function App(){
 ...
 return <><header><a className="brand" href="#"><img src="/public_logo.jpg"/><span>TrekX <b>Delivery</b></span></a><nav className={menu?"open":""}><a href="#home">Home</a><a href="#how">How it works</a><a href="#riders">Become a rider</a><button onClick={()=>setTab("signin")}>Sign in</button></nav><button className="hamb" onClick={()=>setMenu(!menu)}>{menu?<X/>:<Menu/>}</button></header>
